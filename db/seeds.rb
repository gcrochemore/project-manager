...
ProjectBundle.create!([
  ...
  {name: "Sprint 3.2", project_id: 1, estimated_time: 15.5}
])
Task.create!([
  {identifier: 51669, name: "Ajouter l'indicateur Nombre d'actions en cours (RG0125) dans page Constats et plans d'actions", description: "_Evolution_", project_id: 1, project_bundle_id: 2, task_id: nil, estimated_time: 0.5},
  {identifier: 51668, name: "Ouvrir la page Constats/Actions en cours à partir de l'indicateur Nbre actions en cours (RG0125)", description: "_Evolution_\r\n", project_id: 1, project_bundle_id: 2, task_id: nil, estimated_time: 0.5},
  {identifier: 51614, name: "Le contrôle sur le format du fichier n'est pas affiché lors de la dépose du fichier", description: "_Anomalie_\r\n", project_id: 1, project_bundle_id: 2, task_id: nil, estimated_time: 1.5},
  ...
  {identifier: 50982, name: "API - Constats/Plans d'action - Ajout d'une zone commentaire", description: "Développement ", project_id: 1, project_bundle_id: nil, task_id: 16, estimated_time: 1.0},
  {identifier: 50983, name: "APP - Constats/Plans d'action - Ajout d'une zone commentaire", description: "Développement ", project_id: 1, project_bundle_id: nil, task_id: 16, estimated_time: 1.0},
  {identifier: nil, name: "Redirection depuis Nombre action en cours vers page constats et plans d'actions", description: "", project_id: 1, project_bundle_id: nil, task_id: 2, estimated_time: 0.5},
  {identifier: nil, name: "Ajouter l'indicateur Nombre d'actions en cours (RG0125) dans page Constats et plans d'actions", description: "", project_id: 1, project_bundle_id: nil, task_id: 1, estimated_time: 0.5},
  {identifier: nil, name: "API - Expliciter le message d'erreur si le document n'est pas autorisé", description: "", project_id: 1, project_bundle_id: nil, task_id: 3, estimated_time: 0.5},
  {identifier: nil, name: "APP - Faire un controle sur le format de fichier avant téléchargement", description: "", project_id: 1, project_bundle_id: nil, task_id: 3, estimated_time: 1.0}
])
